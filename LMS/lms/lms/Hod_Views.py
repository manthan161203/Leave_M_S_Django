...
from lm_system.models import Session_Year,Course,CustomUser,Student,Staff,Subject,Staff_Notification,Staff_leave,Student_Notification,Student_leave,Student_leave,Student_leave
...
def ADD_STUDENT(request):
    ...
    if request.method == 'POST':
        ...
        if CustomUser.objects.filter(email=email).exists() and CustomUser.objects.filter(username=username).exists():
            messages.warning(request,'E-mail and Username are Already Taken !')
            return redirect('add_student')

        elif CustomUser.objects.filter(email=email).exists():
            messages.warning(request,'E-mail is Already Taken !')
            return redirect('add_student')
...
def ADD_COURSE(request):
    ...
    if request.method == "POST":
        ...
        # engine.say("Course is successfully added")
...
def UPDATE_STAFF(request):
    ...
    if request.method == 'POST':
        ...
        messages.success(request,'Faculty Data is Successfully Updated!')
...
def DELETE_STAFF(request,admin):
    ...
    staff.delete()
    messages.success(request,'Faculty Data is Successfully Deleted!')
    return redirect('view_staff')
